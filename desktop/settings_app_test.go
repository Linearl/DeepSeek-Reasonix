...
`
	...
	// Task 63: official Flash is image-capable through the vendor table (it
	// routes to V4.1 Flash), so the preserved override is neither needed nor
	// able to change the answer; the assertion below still proves it survived.
