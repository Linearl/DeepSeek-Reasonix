...
const en = {
  ...
  "providerUI.guardianModelHelp": "Follow the conversation model: the run reviews its own requests, so it shares that model's blind spots.\n\nPick another model to run the safety review instead: it screens risky actions before they reach you, and - in Autopilot mode - answers approval prompts nobody replies to.",
  ...
  "providerUI.unsavedModelChanges": "Model list changed — click Save below to persist it.",
  ...
  "providerUI.testTiming": "First token {ttft} ms · {tps} tok/s",
  "providerUI.testTimingTTFT": "First token {ttft} ms",
  "providerUI.testTimingFull": "First token {ttft} ms · {tps} tok/s · {tokens} tokens in {gen} ms",
  "providerUI.testNoTiming": "Connected · no streamed text, so TTFT/TPS could not be measured",
...
const zh: Record<keyof typeof en, string> = {
  ...
  "providerUI.guardianModelHelp": "跟随会话模型：由运行中的模型自我审核，会带上同一份盲点。\n\n指定其它模型后，改由它做安全审核：在高危动作到达你之前先筛查，并在 Autopilot 模式下代为判断无人应答的审批请求。",
  ...
  "providerUI.unsavedModelChanges": "模型列表已变更——请点击下方「保存」才会写入配置。",
  ...
  "providerUI.testTiming": "首字 {ttft} ms · {tps} tok/s",
  "providerUI.testTimingTTFT": "首字 {ttft} ms",
  "providerUI.testTimingFull": "首字 {ttft} ms · {tps} tok/s · {tokens} tokens / {gen} ms",
  "providerUI.testNoTiming": "连接正常 · 未收到流式文本，无法测量 TTFT/TPS",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  "providerUI.guardianModelHelp": "跟隨對話模型：由執行中的模型自我審核，會帶上同一份盲點。\n\n指定其他模型後，改由它做安全審核：在高危動作到達你之前先篩查，並在 Autopilot 模式下代為判斷無人應答的審批請求。",
  ...
  "providerUI.unsavedModelChanges": "模型清單已變更——請點擊下方「儲存」才會寫入設定。",
  ...
  "providerUI.testTimingTTFT": "首字 {ttft} ms",
  "providerUI.testTimingFull": "首字 {ttft} ms · {tps} tok/s · {tokens} tokens / {gen} ms",
  "providerUI.testNoTiming": "連線正常 · 未收到串流文字，無法測量 TTFT/TPS",
