  ...
  return {
    async GetProjectTreeSnapshot() {
      return {
        ...
        catalog: { state: "ready", mode: "memory", revision: 1, indexed: 4, total: 4, repairPending: 0, sourceCount: 4, canRebuild: false },
        indexed: 4,
        total: 4,
        indexingDone: true,
      };
    ...
    async GetSessionCatalogStatus() {
      return { state: "ready", mode: "memory", revision: 1, indexed: 4, total: 4, repairPending: 0, sourceCount: 4, canRebuild: false };
    },
